    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="py-16 gradient-dark">
                <div className="container">
                    <h2 className="text-3xl md:font-display text-4xl font-bold tracking-tight text-center mb-6">
                        Platform Integrations
                    </h2>
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        {['Shopify', 'WooCommerce', 'Magento', 'Custom API'].map((platform) => (
                            <div key={platform} className="bg-card border-border rounded-xl px-8 py-4 text-center">
            ...
            <section className="py-16 bg-card/30">
                <div className="container">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <h2 className="font-display text-3xl font-bold tracking-tight mb-4">Scale Your E-commerce Delivery</h2>
